...
internal object PokemonTower_5F_EventScript_ItemNugget : Script {
  override suspend fun run(ctx: ScriptContext) {
    ctx.findItem(Items.NUGGET, KantoFlags.FLAG_HIDE_POKEMON_TOWER_5F_NUGGET, 5)
  }
}
...
internal object PokemonTower_5F_EventScript_ItemCleanseTag : Script {
  override suspend fun run(ctx: ScriptContext) {
    ctx.findItem(Items.CLEANSE_TAG, KantoFlags.FLAG_HIDE_POKEMON_TOWER_5F_CLEANSE_TAG, 6)
  }
}
