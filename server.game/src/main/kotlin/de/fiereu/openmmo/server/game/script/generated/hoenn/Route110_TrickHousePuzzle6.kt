...
internal object Route110_TrickHousePuzzle6_EventScript_ItemGlitterMail : Script {
  override suspend fun run(ctx: ScriptContext) {
    ctx.findItem(Items.GLITTER_MAIL, HoennFlags.FLAG_ITEM_TRICK_HOUSE_PUZZLE_6_GLITTER_MAIL, 3)
  }
}
...
internal object Route110_TrickHousePuzzle6_EventScript_Scroll : Script {
  override suspend fun run(ctx: ScriptContext) {
    if (ctx.getVar(HoennVars.VAR_TRICK_HOUSE_PUZZLE_6_STATE) == 0)
        return Route110_TrickHousePuzzle6_EventScript_FoundScroll.run(ctx)
 ...
 * ```
 */
internal object Route110_TrickHousePuzzle6_EventScript_FoundScroll : Script {
  override suspend fun run(ctx: ScriptContext) {
    ctx.setVar(HoennVars.VAR_TRICK_HOUSE_PUZZLE_6_STATE, 1)
...
internal val Route110_TrickHousePuzzle6Scripts: Map<String, Script> =
    mapOf(
        ...
        "Route110_TrickHousePuzzle6_EventScript_FoundScroll" to
