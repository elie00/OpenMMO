...
internal object Route110_TrickHousePuzzle4_EventScript_ItemMechMail : Script {
  override suspend fun run(ctx: ScriptContext) {
    ctx.findItem(Items.MECH_MAIL, HoennFlags.FLAG_ITEM_TRICK_HOUSE_PUZZLE_4_MECH_MAIL, 3)
  }
}
...
internal object Route110_TrickHousePuzzle4_EventScript_Scroll : Script {
  override suspend fun run(ctx: ScriptContext) {
    if (ctx.getVar(HoennVars.VAR_TRICK_HOUSE_PUZZLE_4_STATE) == 0)
        return Route110_TrickHousePuzzle4_EventScript_FoundScroll.run(ctx)
 ...
 * ```
 */
internal object Route110_TrickHousePuzzle4_EventScript_FoundScroll : Script {
  override suspend fun run(ctx: ScriptContext) {
    ctx.setVar(HoennVars.VAR_TRICK_HOUSE_PUZZLE_4_STATE, 1)
...
internal val Route110_TrickHousePuzzle4Scripts: Map<String, Script> =
    mapOf(
        ...
        "Route110_TrickHousePuzzle4_EventScript_FoundScroll" to
